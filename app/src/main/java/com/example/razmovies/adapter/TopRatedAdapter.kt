...
class TopRatedAdapter : ListAdapter<ResultsItem,
        TopRatedAdapter.ItemViewHolder>(DiffCallback) {
    ...
    class ItemViewHolder(var binding: GridViewItemBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(moviesData: ResultsItem) {
            ...
            binding.moviePoster.setOnClickListener {
                ...
                val action = TopRatedMoviesFragmentDirections.actionTopRatedMoviesFragmentToDetailsFragment(
