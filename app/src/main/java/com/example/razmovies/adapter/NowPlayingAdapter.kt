...
import com.example.razmovies.NowPlayingMoviesFragmentDirections
...
class NowPlayingAdapter : ListAdapter<ResultsItem,
        NowPlayingAdapter.ItemViewHolder>(DiffCallback) {
    ...
    class ItemViewHolder(var binding: GridViewItemBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(moviesData: ResultsItem) {
            ...
            binding.moviePoster.setOnClickListener {
                ...
                val action = NowPlayingMoviesFragmentDirections
                    .actionNowPlayingMoviesFragmentToDetailsFragment(
